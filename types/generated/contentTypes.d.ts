...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    HeroBanner: Schema.Attribute.Component<'ui.hero-banner', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLiveDateLiveDate extends Struct.CollectionTypeSchema {
  collectionName: 'live_dates';
  info: {
    description: '';
    displayName: 'Live-date';
    pluralName: 'live-dates';
    singularName: 'live-date';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    link: Schema.Attribute.Component<'ui.links', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPrimaryNavBarPrimaryNavBar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::primary-nav-bar.primary-nav-bar'
    >;
